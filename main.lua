...
pcall(function()
    ...
    local function createTab(name)
        ...
        local offset = #TabsFrame:GetChildren()
        btn.Size = UDim2.new(1, 0, 0, 50)
        btn.Position = UDim2.new(0, 0, 0, (offset-1)*50)
    ...
    local function createSection(parent, text)
        ...
        lbl.Position = UDim2.new(0, 10, 0, count*30)
    ...
    local function createButton(parent, text, callback)
        ...
        btn.Position = UDim2.new(0, 10, 0, count*35)
    ...
    local function createToggle(parent, text, default, callback)
        ...
        frame.Position = UDim2.new(0, 10, 0, count*35)
