-- KaLiHub V2 - Tab Content Frame Fixed Inside Main GUI
...
Minimize.MouseButton1Click:Connect(function()
    ...
    if not Floating then
        ...
        Floating.Size = UDim2.new(0,40,0,40)
        Floating.Position = lastPos
        Floating.BackgroundColor3 = Color3.fromRGB(70,170,255)
        Floating.Text = "K"
        Floating.TextColor3 = Color3.fromRGB(255,255,255)
        Floating.Font = Enum.Font.GothamBold
        Floating.TextSize = 18
...
function KaLiHub:CreateTab(name)
    ...
    function Tab:Button(btnName)
        ...
        TabContents[btnName] = {Frame = Frame}
        return SubTab
    end
